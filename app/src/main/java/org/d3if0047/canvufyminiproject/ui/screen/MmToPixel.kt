...
@Composable
fun MmToPixel(navHostController: NavHostController){
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.judul_pixelmm),
                style = TextStyle(
...
@Composable
fun MmToPixelScreen() {
    var mmText by rememberSaveable { mutableStateOf("") }
    ...
    Column(
        ...
        TextField(
            ...
            label = { Text(text = stringResource(R.string.input_value_mm)) },
        ...
        Row {
            Button(
                onClick = {
                    ...
                    val mm = mmText.toFloatOrNull()
                    mm?.let {
                        pixelValue = convertMmToPixel(mm, roundValue)
                    }
                },
...
fun convertMmToPixel(mm: Float, round: Boolean): Float {
    val pixelPerMm = 3.7795275591f
    var result = mm * pixelPerMm
    if (round) {
...
//        MmToPixel(rememberNavController())
//    }
//}
